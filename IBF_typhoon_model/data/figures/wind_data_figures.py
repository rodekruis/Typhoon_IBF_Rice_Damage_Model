...
df_combined = pd.merge(
    df_admin, df_wind, how="left", left_on=["ADM3_PCODE"], right_on=["adm3_pcode"]
)
# # %%
...
path = os.path.join(cdir, "IBF_typhoon_model\\data\\figures\\wind_figure_new.png")
